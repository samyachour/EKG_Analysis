...
zip entry.zip challenge.py model.py wave.py answers.txt AUTHORS.txt biosppy-0.1.2.zip dependencies.txt detect_peaks.py LICENSE.txt next.sh numpy-1.12.1.tar.gz pandas-0.19.2.tar.gz prepare-entry.sh PyWavelets-0.5.2.tar.gz scipy-0.19.0.tar.gz setup.sh 
